...
/**
 * A configuration object for floats
 */
    ...
    implements IWatchable<number>
{
    ...
    /** The multiple value that may be stored */
    public readonly multiple = new Derived(watch => watch(this._value).multiple);
