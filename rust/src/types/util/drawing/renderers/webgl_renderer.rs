...
use crate::types::util::drawing::{diagram_layout::DiagramLayout, renderer::Renderer};
...
impl<T: Tag> Renderer<T> for WebglRenderer {
    fn render(
        ...
        fn render(context: &WebGl2RenderingContext) -> Result<(), JsValue> {
